...
const scheduleSchema = new Schema(
  {
    ...
    duration_hours: { type: Number, default: 0, min: 0 },
  },
  { _id: false }
);
...
const pricingSchema = new Schema(
  {
    unit: { type: String, enum: Object.values(PricingUnit), required: true },
...
const bookingSchema = new Schema<IBookingDocument>(
  {
    ...
    client_notes: { type: String, default: "", trim: true },
    worker_response: { type: String, default: "", trim: true },
