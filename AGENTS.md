...
├── CLIENT/          # Next.js 16 full-featured frontend (port 3001) — has its own AGENTS.md
...
The `CLIENT/` directory has its own `AGENTS.md` with detailed guidance — read it when working in that app.
