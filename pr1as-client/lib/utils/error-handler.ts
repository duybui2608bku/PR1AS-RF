...
const ERROR_CODE_MESSAGES: Record<string, string> = {
  ...
  ESCROW_NOT_FOUND: "Không tìm thấy giao dịch ký quỹ.",
  ESCROW_RELEASE_FAILED: "Không thể giải ngân ký quỹ.",
  ESCROW_UNAUTHORIZED_ACCESS: "Bạn không có quyền truy cập giao dịch ký quỹ này.",
...
const SERVER_MESSAGE_TRANSLATIONS: Record<string, string> = {
  ...
  "Escrow has already been released": "Ký quỹ đã được giải ngân.",
  "Escrow released successfully": "Đã giải ngân ký quỹ.",
  "Escrow transaction fetched successfully": "Đã tải giao dịch ký quỹ.",
  "Escrow transaction not found": "Không tìm thấy giao dịch ký quỹ.",
  "Escrow transactions fetched successfully": "Đã tải danh sách giao dịch ký quỹ.",
  ...
  "Failed to release escrow": "Không thể giải ngân ký quỹ.",
  ...
  "Too many authentication attempts, please try again later": "Có quá nhiều lần thử đăng nhập. Vui lòng thử lại sau.",
  ...
  "You do not have permission to access this escrow transaction": "Bạn không có quyền truy cập giao dịch ký quỹ này.",
